    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a
          ...
          className={`font-heading text-xl md:text-2xl font-semibold transition-colors duration-500 ${
        ...
        <div className="hidden lg:flex items-center gap-1">
          {data.navbar.links.map((link, index) => (
            <a
              ...
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 hover:text-primary ${
