        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          ...
          <div className="flex bg-white p-1 rounded-full shadow-sm border border-gray-100">
            <button
              ...
              className={`px-6 py-2 rounded-full text-xs md:text-sm font-medium transition-all cursor-pointer ${
                sortBy === 'distance_km'
                ...
                <div className="p-5 md:p-6 flex flex-col flex-1">
                  ...
                  <div className="space-y-3 mb-6 flex-1 section-body">
                    ...
                    <div className="flex items-center justify-between">
                      <div
                        className={`flex items-center gap-2 ${sortBy === 'distance_km' ? 'text-primary font-bold' : ''}`}
                      >
                        <Navigation className="w-4 h-4 shrink-0" />
                        <span className="font-medium">{option.distance}</span>
                      </div>
                      <div
                        className={`flex items-center gap-1 ${sortBy === 'price_val' ? 'text-primary font-bold' : ''}`}
                      >
                        <span
                          className={`${sortBy === 'price_val' ? 'text-primary/60' : 'text-gray-400'}`}
                        >
                          {option.price_range}
                        </span>
